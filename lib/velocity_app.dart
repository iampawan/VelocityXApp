mixin VelocityApp {
  ...
  static const String helloWorldExampleText =
      ''''hello world'.text.black.bold.xl.make().box.red500.p16.roundedLg.shadow2xl.make()''';

  static const String getStartedText = "Get Started";
  static const String versionText = "^0.3.0";
}
