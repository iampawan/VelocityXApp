...
class PaddingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return VelocityScaffold(
      ...
      body: VStack(
        [
          "VelocityX includes a predefined paddings to use them easily with a single click.".text.xl.semiBold.make(),
          10.heightBox,
          Wrap(
            runSpacing: 20,
            spacing: 20,
          ...
          Wrap(
            ...
            children: <Widget>[
              ...
              [
                ...
                CodeBox(CodeBoxText("anywidget.px{number}\n\neg: Text().px8()\n\nIt will give 8px horizontally.")),
                "Other available paddings".text.xl.bold.blue800.make(),
                VelocityDiscList(
                  [
                    "px0()",
              ...
              [
                ...
                CodeBox(CodeBoxText("anywidget.py{number}\n\neg: Text().py16()\n\nIt will give 16px vertically.")),
                "Other available paddings".text.xl.bold.blue800.make(),
                VelocityDiscList(
                  [
                    "py0()",
