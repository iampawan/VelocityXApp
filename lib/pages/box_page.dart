    ...
    return VelocityScaffold(
      ...
      body: VStack(
        [
          ...
          10.heightBox,
          CodeBox(CodeBoxText(
              "{anywidget}.box.hexColor(String colorHex).make();\n\neg: Text('VelocityX').box.hexColor(\"#ffffff\").make();\n\nIt will produce a box with white color.")),
          20.heightBox,
          ...
          10.heightBox,
          CodeBox(CodeBoxText("Text('VelocityX').box.alignment(Alignment(10,20)).make();\n\nwhere 10,20 are the x,y aligment.")),
          20.heightBox,
          ...
          10.heightBox,
          CodeBox(CodeBoxText("Text('VelocityX').box.shadowOutline(Colors.black).make();\n\nsets shadow outline with black color.")),
          20.heightBox,
          "Transform".text.xl2.make(),
          10.heightBox,
          "VelocityX offers transform method".text.make(),
          10.heightBox,
          CodeBox(CodeBoxText("Text('VelocityX').box.transform(Matrix4.identity()).make();")),
          20.heightBox,
          ...
          10.heightBox,
          CodeBox(CodeBoxText("Text('VelocityX').box.withRounded(20).make();\n\nsets custom border radius as 20.")),
          20.heightBox,
          ...
          10.heightBox,
          CodeBox(CodeBoxText("Text('VelocityX').box.border(color:Colors.black,width:1.0,style:BorderStyle.solid).make();")),
          20.heightBox,
          "Background Image".text.xl2.make(),
          10.heightBox,
          "VelocityX offers bgImage method".text.make(),
          10.heightBox,
          CodeBox(CodeBoxText("Text('VelocityX').box.bgImage(DecorationImage image).make();")),
          20.heightBox,
