  ...
  Widget build(BuildContext context) {
    ...
    return VelocityScaffold(
      ...
      body: VStack([
        ...
        30.heightBox,
        "Align widgets Using VelocityX object method extention"
            .text
            .xl2
            .blue800
            .semiBold
        ...
        Wrap(
          ...
          children: <Widget>[
            [
              "Align Widget in Center".text.xl.bold.blue800.make(),
              CodeBox(CodeBoxText(
                  "anywidget.objectCenter()\n\neg: Text().objectCenter()\n\nIt will align the text in the Center of the box.")),
            ].vStack().w(width),
            [
              "Align Widget in Top-Center".text.xl.bold.blue800.make(),
              CodeBox(CodeBoxText(
        ...
        Wrap(
          ...
          children: <Widget>[
            [
              "Align Widget in Center-Left".text.xl.bold.blue800.make(),
              CodeBox(CodeBoxText(
                  "anywidget.objectCenterLeft()\n\neg: Text().objectCenterLeft()\n\nIt will align the text in the Center-Left of the box.")),
            ].vStack().w(width),
            [
              "Align Widget in Top-Left".text.xl.bold.blue800.make(),
              CodeBox(CodeBoxText(
        ...
        Wrap(
          ...
          children: <Widget>[
            [
              "Align Widget in Center-Right".text.xl.bold.blue800.make(),
              CodeBox(CodeBoxText(
                  "anywidget.objectCenterRight()\n\neg: Text().objectCenterRight()\n\nIt will align the text in the Center-Right of the box.")),
            ].vStack().w(width),
            [
              "Align Widget in Top-Right".text.xl.bold.blue800.make(),
              CodeBox(CodeBoxText(
        ...
        30.heightBox,
        "Fit widgets in a contianer Using VelocityX object method extention"
            .text
            .xl2
            .blue800
            .semiBold
        ...
        HStack([
          "Fill the image in the available space of the container using "
              .text
              .make(),
          5.widthBox,
          InlineCodeBox(InlineCodeBoxText("{anywidget}.objectFill()")),
          10.widthBox,
          "The below example shows how exactly this method works.".text.make(),
        ]),
        20.heightBox,
        Wrap(
          runSpacing: 20,
          ...
          children: <Widget>[
            [
              CodeBox(CodeBoxText(
                  "VxBox(\n\tchild: \n\t\tImage(\n\t\timage: AssetImage(\"img.png\"),\n\t).objectFill()\n).orange300.make().h20(context).w24(context)")),
            ].vStack().w(width + 200),
          ],
        ),
        20.heightBox,
        VxBox(
          child: Image(
            ...
            .border(color: Colors.indigoAccent, width: 2.0)
            .orange300
            .make()
            .h20(context)
            .w24(context),
        ...
        HStack([
          "Covert the image in the available space of the container using "
              .text
              .make(),
          5.widthBox,
          InlineCodeBox(InlineCodeBoxText("{anywidget}.objectCover()")),
          10.widthBox,
          "The below example shows how exactly this method works.".text.make(),
        ]),
        20.heightBox,
        ...
        HStack([
          "Contain the image in the available space of the container using "
              .text
              .make(),
          5.widthBox,
          InlineCodeBox(InlineCodeBoxText("{anywidget}.objectContain()")),
          10.widthBox,
          "The below example shows how exactly this method works.".text.make(),
        ]),
        20.heightBox,
        ...
        HStack([
          "Scale Down the image in the available space of the container using "
              .text
              .make(),
          5.widthBox,
          InlineCodeBox(InlineCodeBoxText("{anywidget}.objectScaleDown()")),
          10.widthBox,
          "The below example shows how exactly this method works.".text.make(),
        ]),
        20.heightBox,
