    ...
    return VelocityScaffold(
      ...
      body: VStack(
        [
          ...
          10.heightBox,
          CodeBox(CodeBoxText("Text('VelocityX').card.withRounded(20).make();\n\nsets custom border radius as 20.")),
