    ...
    return VelocityScaffold(
      ...
      body: VStack(
        [
          ...
          CodeBox(CodeBoxText("eg: 'Velocityx'.text.bold.make();\n\nSets the fontweight as bold(w700)")),
          20.heightBox,
          ...
          CodeBox(CodeBoxText("eg: 'Velocityx'.text.center.make();\n\nSets the alignment of the text as center")),
          20.heightBox,
          ...
          CodeBox(CodeBoxText("eg: 'Velocityx'.text.wide.make();\n\nSets the letter spacing as 1.0 of the text")),
          10.heightBox,
          ...
          CodeBox(CodeBoxText("eg: 'Velocityx'.text.underline.make();\n\nSets the text to undelined.")),
          20.heightBox,
          ...
          CodeBox(CodeBoxText("eg: 'Velocityx'.text.heightSnug.make();\n\nSets the line height as 0.875 of the text")),
          10.heightBox,
          "Set a custom line height".text.make(),
          CodeBox(CodeBoxText("eg: 'Velocityx'.text.lineHeight(4.0).make();\n\nSets the line height as 4.0")),
          20.heightBox,
          ...
          CodeBox(CodeBoxText("eg: 'Velocityx'.text.lowercase.make();\n\nSets the text as lowercase - velocityx")),
          20.heightBox,
          "Using all together".text.xl2.make(),
          10.heightBox,
          CodeBox(CodeBoxText("'velocityx'.text.red500.xl2.bold.center.heightRelaxed.underline.wide.uppercase.make()")),
          "Output:".text.make(),
